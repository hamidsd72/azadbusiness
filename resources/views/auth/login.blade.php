...
<div class="body">
    ...
    <div class="body_1" uk-grid>
        ...
        <div class="uk-align-center cont_box_1">
            <div class="cont_box">
                <div class="title_box">
                    <h3>
                ...
                <form method="POST" action="{{route('login')}}" accept-charset="UTF-8"><input name="_token" type="hidden" value="K71u7P9t7dU37sn3ahOUM7LFgYUIKeDECOzbX7Wf">
                    @csrf
                    <div class="control_box">
                        <label for="username" class="float-right">ایمیل</label>
                        <input name="username" type="text" class="text-left" style="direction: rtl" placeholder="ایمیل شما">
                    </div>
                    <div class="control_box">
                    ...
                    <div class="control_box">
                        <ul class="ul">
                            {{-- <li class="check_box w40 text-right">
                                <input name="remember" type="checkbox" placeholder="">
                                مرا به خاطر بسپار
                            </li> --}}
                            <li class="w60 text-left">
