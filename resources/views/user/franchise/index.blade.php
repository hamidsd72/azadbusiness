...
@section('main-nav')
    ...
    @foreach($Menus as $index=>$menu)
        @if($menu->childs()->first())
            ...
            <li><a href="{{route('user.franchise.show',[$menu->slug])}}">{{$menu->title}}</a>
                <ul class="sub-nav">
                    @foreach($menu->childs()->get() as $index=>$menu_2)
                        @if($menu_2->childs()->first())
                            <li><a href="{{route('user.franchise.show',[$menu_2->slug])}}">{{$menu_2->title}}</a>
                                <ul class="sub-nav">
                                    @foreach($menu_2->childs()->get() as $index=>$menu_3)
                                        <li><a  href="{{route('user.franchise.show',[$menu_3->slug])}}">{{$menu_3->title}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        @else
                            <li><a href="{{route('user.franchise.show',[$menu_2->slug])}}">{{$menu_2->title}}</a></li>
                        @endif
                    @endforeach
                </ul>
            </li>
        @else
            <li><a href="{{route('user.franchise.show',[$menu->slug])}}">{{$menu->title}}</a></li>
        @endif
...
@section('main')
                                                        ...
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div class="elementor-element elementor-element-65ae90d0 elementor-widget elementor-widget-aux_modern_heading" data-id="65ae90d0" data-element_type="widget" data-widget_type="aux_modern_heading.default">
                                                                    <div class="elementor-widget-container">
                                                                        <section class="aux-widget-modern-heading">
                                                                            <div class="aux-widget-inner"><h2 class="aux-modern-heading-primary">سرمایه گذاری</h2></div>
                                                                        </section>		</div>
                                                                </div>
                                                                <div class="elementor-element elementor-element-8b41f70 elementor-widget elementor-widget-aux_breadcrumbs" data-id="8b41f70" data-element_type="widget" data-widget_type="aux_breadcrumbs.default">
                                                                    <div class="elementor-widget-container">
                                                                        <div class="aux-elementor-breadcrumbs"><p class="aux-breadcrumbs"><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span><a href="{{url("/")}}" title="Home">خانه</a></span><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span>سرمایه گذاری</span></p>
                                                                        </div>		</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div class="elementor-element elementor-element-49d9de1 aux-appear-watch-animation aux-fade-in-up elementor-widget elementor-widget-aux_modern_heading" data-id="49d9de1" data-element_type="widget" data-widget_type="aux_modern_heading.default">
                                                                    <div class="elementor-widget-container">
                                                                        <section class="aux-widget-modern-heading">
                                                                            <div class="aux-widget-inner"><h2 class="aux-modern-heading-primary"></h2><h3 class="aux-modern-heading-secondary"><span class="aux-head-before">franchise</span></h3><div class="aux-modern-heading-divider"></div><div class="aux-modern-heading-description"><p>{{$franchise->text_short}}</p></div></div>
                                                                        </section>		</div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4"></div>
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
            <div class="total-package shadow-bottom-items">
                <strong>لیست برند ها</strong>
                <div class="price-list">
                    <ul>
                        @foreach($franchise->winners as $name)
                            <li>
                                <span></span>
                                <span>{{$name}}</span>
                            </li>
    ...
    <section class="feature-circle">
        <div class="container">
            <div class="section-heading wow zoomIn" style="visibility: visible; animation-name: zoomIn;">
                <h5>نگاهی به</h5>
                <div class="main-title">
                    <h2><span></span> خدمات ما</h2>
                    <strong></strong> <!-- Use for heading after effect -->
                </div>
            </div> <!-- /.section-heading -->
            <div class="circle-items wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div class="wheel">
                    <div class="feature-things">
                        <span>{{$franchise->service_1}}<strong></strong></span>
                        <span><a href="#"><i class="flaticon-shield"></i></a></span>
                    </div>
                    <div class="feature-things">
                        <span>{{$franchise->service_2}}<strong></strong></span>
                        <span><a href="#"><i class="flaticon-armchair"></i></a></span>
                    </div>
                    <div class="feature-things">
                        <span><a href="#"><i class="flaticon-support"></i></a></span>
                        <span>{{$franchise->service_3}}<strong></strong></span>
                    </div>
                    <div class="feature-things">
                        <span><a href="#"><i class="flaticon-command"></i></a></span>
                        <span>{{$franchise->service_4}}<strong></strong></span>
                    </div>
                    <!-- <div class="border-circle"></div> -->
                    <div class="feature-main-img">
                        <img src="{{asset('images/bg/feature-bg.png')}}" alt="Feature">
                    </div>
                </div> <!-- /.wheel -->
            </div> <!-- /.circle-items -->
        </div> <!-- /.container -->
