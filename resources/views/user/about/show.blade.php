...
@section('head')
        ...
        <style type="text/css">.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style><link rel="icon" href="{{asset('/images/LogoAzad.jpg')}}" sizes="32x32" />
        <link rel="icon" href="{{asset('/images/LogoAzad.jpg')}}" sizes="192x192" />
        <link rel="apple-touch-icon" href="{{asset('/images/LogoAzad.jpg')}}" />
                                                        ...
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div class="elementor-element elementor-element-65ae90d0 elementor-widget elementor-widget-aux_modern_heading" data-id="65ae90d0" data-element_type="widget" data-widget_type="aux_modern_heading.default">
                                                                    <div class="elementor-widget-container">
                                                                        <section class="aux-widget-modern-heading">
                                                                            <div class="aux-widget-inner"><h2 class="aux-modern-heading-primary">درباره ما</h2></div>
                                                                        </section>		</div>
                                                                </div>
                                                                <div class="elementor-element elementor-element-8b41f70 elementor-widget elementor-widget-aux_breadcrumbs" data-id="8b41f70" data-element_type="widget" data-widget_type="aux_breadcrumbs.default">
                                                                    <div class="elementor-widget-container">
                                                                        <div class="aux-elementor-breadcrumbs"><p class="aux-breadcrumbs"><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span><a href="https://demo.phlox.pro/architect" title="Home">خانه</a></span><span class="aux-breadcrumb-sep breadcrumb-icon auxicon-chevron-right-1"></span><span>درباره ما</span></p>
                                                                        </div>		</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="elementor-column-wrap elementor-element-populated">
                                                            <div class="elementor-widget-wrap">
                                                                <div class="elementor-element elementor-element-49d9de1 aux-appear-watch-animation aux-fade-in-up elementor-widget elementor-widget-aux_modern_heading" data-id="49d9de1" data-element_type="widget" data-widget_type="aux_modern_heading.default">
                                                                    <div class="elementor-widget-container">
                                                                        <section class="aux-widget-modern-heading">
                                                                            <div class="aux-widget-inner"><h2 class="aux-modern-heading-primary">{{$item->title}}</h2><h3 class="aux-modern-heading-secondary"><span class="aux-head-before">خلاصه توضیحات</span></h3><div class="aux-modern-heading-divider"></div><div class="aux-modern-heading-description"><p>{{$item->text_short}}</p></div></div>
                                                                        </section>		</div>
                                                                </div>
                                                            </div>
                                                        </div>
