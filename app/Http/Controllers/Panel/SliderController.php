...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('photo')) {
                $photo = new Photo();
                $photo->path = file_store($request->photo, 'source/assets/uploads/sliders/' . my_jdate(date('Y/m/d'), 'Y-m-d') . '/photos/', 'photo-');;
    ...
    {
//        Optimizer::saveAs('source/assets/uploads/sliders/1399-07-06/photos/photo-90361b1bd5b3f4e5f11abf35f0395bd2.jpg');
//
//        return redirect()->back();
        $this->validate($request, [
            'title' => 'required|max:191',
